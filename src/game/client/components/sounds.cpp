...
void CSoundLoading::Run()
{
	...
	{
		const char *pLoadingCaption = Localize("Loading chillerbot-ux");
...
void CSounds::OnInit()
{
	...
	if(g_Config.m_ClThreadsoundloading)
	{
		...
		m_pClient->m_Menus.RenderLoading(Localize("Loading chillerbot-ux"), Localize("Loading sound files"), 0);
	}
	else
	{
